...
class JigsawImageController {
  static async generateAndGetImage(req, res) {
    ...
    const monthPrompts = {
      ...
      "04": "Spring scenery with blooming flowers and trees",
      "05": "Diwali festival celebration with lights and fireworks",
      "06": "Summer beach scene with sun and waves",
      "07": "Rainy monsoon scenery with umbrellas and puddles",
